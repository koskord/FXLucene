 ...
 * compatibility when creating MyAnalyzerPrtSt:
 * <ul>
...
public final class CustomAnalyzer extends StopwordAnalyzerBase {
  ...
  public final Set<?> STOP_WORDS_SET = StopAnalyzer.ENGLISH_STOP_WORDS_SET; 
  ...
  public CustomAnalyzer(Version matchVersion, Set<?> stopWords) {
    super(matchVersion);
    replaceInvalidAcronym = matchVersion.onOrAfter(Version.LUCENE_47);
  }
